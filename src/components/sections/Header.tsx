...
const Header = () => {
    return (
        <HeaderComponent>
            ...
            <HeadingTwo variants={HeadingVariants} initial='hidden' animate='visible' transition={{delay:2.4,type:'tween'}} color='#eaeaea'>I'm sdasdsdasdsdy</HeadingTwo>
            ...
            <Button variants={HeadingVariants} initial='hidden' animate='visible' transition={{delay:3,type:'tween'}} padding='15px 30px' shadowTop='5px'>Contact Me</Button>
        </HeaderComponent>
    )
}
